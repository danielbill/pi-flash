...
# closure ends at first line after li that is exactly 16 spaces + '})'
ej = next(j for j in range(li, len(lines)) if lines[j].rstrip() == '})')
...
print('closure rebuilt between', li + 2, 'and', ej + 1)
